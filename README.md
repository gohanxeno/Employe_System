...
Nodejs , Express, Mongodb , EJS , javaScript , html, css, ejs

### How to setup the project on local system

  1. Clone this project or download zip file
  2. Start by installing required packages
  3. Navigate to Project Directory.

Now install npm is allready present them..
   ```` 
        npm install *****
        npm start || nodemon index.js
   ````

#### If you want to make an employee as admin then use the secret key : qwerty.
